...
var player,playerImg,heart3Img,heart2Img,heart1Img,heart0Img;
...
var laserBSound,explosionSound;
...
function preload(){
        ...
        heart0Img = loadImage("Assets/Player/playerLife0.png");
        heart1Img = loadImage("Assets/Player/playerLife1.png");
        heart2Img = loadImage("Assets/Player/playerLife2.png");
        heart3Img = loadImage("Assets/Player/playerLife3.png");
...
function draw(){
   ...
   playButton.mousePressed(() =>{
    ...
    if(gameState == "level1" || gameState == "level2"){
       ...
       // playerLife.addImage(heart3Img);

       if(playerLife == 3){
            image(heart3Img,80,40,90,50);
       } if(playerLife == 2){
            image(heart2Img,80,40,90,50);
       }if(playerLife == 1){
            image(heart1Img,80,40,90,50);
       }if(playerLife == 0){
            image(heart0Img,80,40,90,50);
       }
...
function level1Win(){
    ...
    swal({
        ...
        textSize: "70x70",
        textAlign: "CENTER",
        imageUrl:"Assets/endScreens/gameWin1.gif",
        imageSize: "250x250",
...
function gameOver(){
    ...
    swal({
        ...
        imageUrl: "Assets/endScreens/crashing.gif",
        imageSize:"300x300",
        title: "Game Over",
        text: "Sorry! you crashed. Try Again",
        textSize:20,
        textAlign: "CENTER",
        confirmButtonText:"Try Again",
        confirmButtontextSize:"20x20",
...
function gameWon(){
    ...
    swal({
        ...
        textSize:20,
        textAlign: "CENTER",
        imageUrl: "Assets/endScreens/gameWin2.gif",
        imageSize:"300x300",
